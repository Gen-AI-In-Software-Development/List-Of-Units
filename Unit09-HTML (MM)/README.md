...
2.	Use Microsoft Copilot to generate an HTML page that includes: a) An image from an external source (e.g., Unsplash, Pixabay). b) An embedded YouTube video. c)An embedded Google Maps location.
